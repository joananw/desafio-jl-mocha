Desafio #4 - Mentoria em Testes de Software<br/>
Grupo:<br/>
Djalma Porto<br/>
...
Instruções para utilizar a aplicação:<br/>
1) para garantir a instalação de todas as dependências:<br/>
npm install<br/>
2) para rodar o arquivo de teste:<br/>
npm test<br/>
